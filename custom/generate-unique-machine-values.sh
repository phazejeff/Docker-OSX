...
download_vendor_mac_addresses () {
    ...
    [ -e "${MAC_ADDRESSES_FILE:=vendor_macs.tsv}" ] || wget -O "${MAC_ADDRESSES_FILE}" https://gitlab.com/wireshark/wireshark/-/raw/6ed7571150f187cefef2ffde13b70f59e0b3b024/manuf
}
